...
<br><br>
           ...
           <form method="post" id="chef" action="<?=base_url('seller-store')?>" >
        ...
        <div class="q input">
            ...
            <br><br>       
                    <a class="item_anchor" name="ItemAnchor4"></a>
                                   <label class="question top_question" for="Address_1">Address 1:
                                    <b class="icon_required" style="color:#FF0000">*</b>&nbsp;&nbsp;
                                      </label>
                                <input type="text" name="Address_1" required class="text_field" id="Address_1" size="25" value="">&nbsp;&nbsp;&nbsp;
                 
                 

                 
                    <a class="item_anchor" name="ItemAnchor5"></a>
                                    <label class="question top_question" for="Address_2">Address 2:
                                        <b class="icon_required" style="color:#FF0000">*</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    </label>
                                 <input type="text" name="Address_2" class="text_field" id="Address_2" size="25" value="">
            ...
            <br><br>       
                    ...
                    <a class="item_anchor" name="ItemAnchor11"></a>
                                     <label class="question top_question" for="constituency">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Constituency:
                                        <b class="icon_required" style="color:#FF0000">*</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        </label>
            ...
            <br><br>
             ...
             <br><br>
                    ...
                    <a class="item_anchor" name="ItemAnchor12"></a>
                       <span class="question top_question">Is your property legally registered in Nairobi?
                       <b class="icon_required" style="color:#FF0000">*</b>&nbsp;
                          </span>
                          <table class="inline_grid choices">
                                  <tbody><tr><td>
                                      <input type="radio" name="legal" class="multiple_choice" id="Yes" value="Yes">
                                      <label for="Yes">Yes</label></td><td>
                                          <input type="radio" name="legal" class="multiple_choice" id="No" value="No">
