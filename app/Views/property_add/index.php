      ...
      <br> <br>
            ...
            <tr>
               ...
               <td>
                ...
                <td>
                    <a href="<?= base_url('homes/edit/'.$item['property_id'])?>"class="btn btn-success btn-sm">Edit</a></br>
                    <a href="<?= base_url('homes/delete/'.$item['property_id'])?>"class="btn btn-danger btn-sm">Delete</a>
