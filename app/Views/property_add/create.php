           ...
           <div class="col-md-7">
                   <div class="card">
                      <div class="card-header">
                           <h5>Add Homes</h5>
                                <a href="<?= base_url('property_add')?>" class="btn btn-danger btn-sm float-end">BACK</a>
                              </h5>
                       </div>
                       <div class="card-body">
                       <form action="<?=base_url('property_add-store')?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <select id="property_type" name="property_type" class="drop_down">
                         <option></option>
                        <option value="Nairobi-West">Rent</option>
                        <option value="Nairobi-East">Sale</option>
