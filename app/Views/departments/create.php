           ...
           <div class="col-md-7">
                   <div class="card">
                      ...
                      <h1 style="text-align:center"><?=$hospital['hospital_name']?></h1>
                       ...
                       <div class="card-body">
                       <form action="<?=base_url('departments-store')?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                 ...
                                 <div class="form-group">
                                       <label for="usr">Department Name</label>
                                            <input type="text" name="department_name" class="form-control" id="usr">
                               </div>
                               
                                   <div class="form-group">
                                        <label for="pwd">Department description</label>
                                        <textarea name="department_description" style=" border-radius: 20px; background:transparent;"id="w3review" name="w3review" rows="4" cols="50"></textarea>
                                   </div>
