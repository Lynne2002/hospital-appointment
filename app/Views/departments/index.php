...
<div class="profile-details">
    ...
    <div class="container mt-4">
        ...
        <input onkeyup="myFunction()"  id ="myInput"type="text" placeholder="Search department">
      ...
      <br> <br>
            ...
            <tr>
                ...
                <td>
                    <a href="<?= base_url('departments/edit/'.$item['department_id'])?>"class="btn btn-success btn-sm">Edit</a></br>
                    <a href="<?= base_url('departments/delete/'.$item['department_id'])?>"class="btn btn-danger btn-sm">Delete</a>
                    
                </td>
                <td>
                <a href="<?= base_url('doctors_add/add/'.$item['department_id'])?>"class="btn btn-primary">Add doctors</a>
                <td>
            </tr>
            <?php endforeach;?>
            </tbody>
