           ...
           <div class="col-md-7">
                   <div class="card">
                      <div class="card-header">
                       ...
                       <div class="card-body">
                       <form action="<?=base_url('hospitals-store')?>" name="ajax_form" id="ajax_form" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                
                            
                            
                                <div class="form-group">
                                         <label for="formGroupExampleInput">Hospital Image</label>
                                           <input type="file" name="hospital_image" class="form-control" id="file">
                                 </div> 
                                 <div class="form-group">
                                       <label for="usr">Hospital Name</label>
                                            <input type="text" name="hospital_name" class="form-control" id="usr">
                               </div>
                               <div class="form-group">
                                   ...
                                   <div class="form-group">
                                     ...
                                     <input type="text" name="lat" class="form-control" id="latitude">
                                   </div>
                                   <div class="form-group">
                                        <label for="pwd">Longitude</label>
                                     <input type="text" name="lng" class="form-control" id="longitude">
                                   </div>
                                   <div class="form-group">
                                         <label for="formGroupExampleInput">No. of departments</label>
                                           <input type="number" name="departments" class="form-control" id="departments">
                                 </div> 
                                 <div class="form-group">
                                         <label for="formGroupExampleInput">No. of doctors</label>
                                           <input type="number" name="doctors" class="form-control" id="doctors">
                                 </div> 
